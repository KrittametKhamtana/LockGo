...
{
    /// <summary>
    /// Switches every primary/foreign key from uuid to a sequential integer.
    ///
    /// DESTRUCTIVE: Postgres has no cast from uuid to integer, so the columns
    /// cannot be altered in place — the tables are dropped and recreated, and
    /// every existing row goes with them. Lockers and compartments come back on
    /// the next startup (DbSeeder is idempotent), but reservations and any
    /// registered accounts do not. Intended for a development database.
    /// </summary>
    public partial class SwitchToSequentialIntIds : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "reservations");
            migrationBuilder.DropTable(name: "compartments");
            migrationBuilder.DropTable(name: "lockers");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("pk_lockers", x => x.id));
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    locker_id = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    compartment_id = table.Column<int>(type: "integer", nullable: false),
        ...
        {
            // Reverting only restores the shape, never the rows — the uuid keys
            // the old rows carried cannot be reconstructed from integers.
            migrationBuilder.DropTable(name: "reservations");
            migrationBuilder.DropTable(name: "compartments");
            migrationBuilder.DropTable(name: "lockers");
            migrationBuilder.DropTable(name: "users");
